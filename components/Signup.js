...
const Signup=({navigation})=>{
  ...
  const [cpassword,setCPasssword] = useState(null);
...
<TextInput 
    ...
    secureTextEntry={true}
    onChangeText={(text)=>{setCPasssword(text)}}
   />
</View>
...
<Text style={styles.Text2} onPress={()=>{verify()}}>SIGNUP</Text>
</TouchableOpacity>

<View style={styles.nav}>
<Text>Already have an account? 
</Text>
<TouchableOpacity onPress={()=>{navigation.navigate('Login')}} ><Text style={styles.tex}>Login</Text></TouchableOpacity>
</View>
